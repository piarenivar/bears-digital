    ...
    return (
        <section className='border-t-gray flex flex-col space-y-6 pt-16'>
            ...
            <div className='w-full flex justify-between'>
                <p className='text-white-translucent w-1/2 text-2xl font-light leading-normal'>Sign up for our newsletter to stay informed, inspired, and ready to stand out from the competition.</p>
