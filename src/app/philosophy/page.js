            ...
            <section className='container flex flex-col pb-16 px-8 space-y-16'>
                <section id='philosophy' className='flex flex-col space-y-6 pt-16'>
                    ...
                    <div className='w-full flex justify-between max-lg:flex-col max-lg:space-y-6'>
                        <p className='text-white-translucent w-3/5 text-2xl font-light leading-relaxed max-lg:w-full max-sm:text-xl max-sm:leading-relaxed'>Bears Digital was founded with a simple purpose: to create digital solutions that transcend the ordinary. We are driven by an unwavering passion for crafting exceptional design and development solutions that enable our clients to scale their growth. Our commitment is to empower businesses in developing their brands to their fullest potential, while providing their customers with meaningful digital experiences. We take immense pride in our work, and we never settle for anything less than extraordinary.</p>
